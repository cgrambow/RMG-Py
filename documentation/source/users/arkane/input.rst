...
``write_to_database``  No                   Write the BACs to arkane/encorr/data.py (default: False)
...
``global_opt_iter``    No                   Number of global optimization iterations (Melius only, default: 15)
``minimizer_maxiter``  No                   Maximum number of iterations in the minimizer (Melius only, default: 100)
====================== ==================== =========================================================================================
